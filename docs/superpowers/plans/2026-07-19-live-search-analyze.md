...
No cache shared across cold instances or users (accepted tradeoff of free
serverless) — /tmp is best-effort, warm-instance-only. No prediction-ledger
...
from mbe.data.cache import DiskCache  # noqa: E402
...
CACHE_DIR = "/tmp/mbe-cache" if os.environ.get("VERCEL") else "data/cache"
